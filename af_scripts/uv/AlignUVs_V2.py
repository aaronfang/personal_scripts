...
class lineUpUVs(object):
    ...
    def _UI(self):
        ...
        pm.rowLayout(p="mainColumn", w=w, h=25, numberOfColumns=4, columnWidth4=(40, 40, 30, 30), adjustableColumn=1, columnAlign=(1, 'right'), columnAttach=[(1, 'both', 0), (2, 'both', 0), (3, 'both', 0), (4, 'both', 0)])
        ...
        pm.rowLayout(p="mainColumn", w=w, h=25, numberOfColumns=3, columnWidth3=(40, 40, 40), adjustableColumn=3, columnAlign=(1, 'right'), columnAttach=[(1, 'both', 0), (2, 'both', 0), (3, 'both', 0)])
