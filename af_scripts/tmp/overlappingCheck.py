...
class overlappingCheck(object):
    ...
    def _UI(self):
        ...
        cmds.rowLayout("mainRow", p="mainColumn", w=w, numberOfColumns=3, columnWidth3=(60, 50, w2), adjustableColumn=3,
                       columnAlign3=[('center'), ('center'), ('center')],
                       columnAttach=[(1, 'both', 1), (2, 'both', 0), (3, 'both', 0)])
        ...
        cmds.textScrollList("overlapListTextScroll", p="mainColumn", numberOfRows=8, allowMultiSelection=True,
                            sc=self.select_item)
